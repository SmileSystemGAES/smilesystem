...
<body>
	<div class="logo">
		<div id="idiomas">
		<a href="../../sitioes/medicos/historial.jsp">Spanish</a> // <a href="../../sitioen/medicos/historial.jsp">English</a>
		</div>
	...
	<div class="menu">
		<div class="tags">
                ...
                <a href="#"><strong>Patient History</strong></a>
              </div>
	...
	<div class="contenido">
	    ...
	    <div class="mesa mesa-overflow">
			...
			<div class="mesa">
	            ...
	            <a href="pdf/medico.pdf" target="_blank"> <button  class="printer" type="button">Download</button> </a>
            </div>            
	    </div> 
	</div>
